                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="{{ url('/edit/'.$agreement->id) }}"><button type="button" class="btn btn-warning btn-sm">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                        viewBox="0 0 512 512">
                                                        <style>
                                                            svg {
                                            ...
                                            <a href="{{ url('/delete/'.$agreement->id) }}"><button type="button" class="btn btn-danger btn-sm">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                        viewBox="0 0 448 512">
                                                        <style>
                                                            svg {
